...
using Encomiendas.Web.Api.Infrastructure.RestExceptions;
using Nancy;
...
using TokenDoesNotExistException = Encomiendas.Web.Api.Infrastructure.Authentication.TokenDoesNotExistException;
